import sys
from PyQt6.QtWidgets import QApplication,QGridLayout,QInputDialog,QGraphicsLineItem,QRadioButton,QAbstractItemView, QGraphicsView,QScrollArea, QGraphicsView, QTableWidgetItem,QFrame, QWidget,QToolBar, QSpacerItem,QMainWindow, QFileDialog, QLabel, QMenu, QPushButton, QVBoxLayout, QStatusBar, QHBoxLayout, QLineEdit, QMessageBox
    ...
    def getFinalAttributes(self, finalNodes):
        ...
        for node in finalNodes:
            if not node.connections:
                self.attributes.append(node.label_name)
